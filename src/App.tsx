...
export default function App() {
	...
	const { data: authorizeData, isLoading: isAuthorizing } = useAuthorize(
		selectedApp || ""
	)
				...
				<Card className="w-full max-w-md">
					<CardContent className="flex flex-col items-center justify-center p-8 space-y-4">
						...
						<p className="text-center text-muted-foreground">
							Yönlendirme döngüsü tespit edildi. Lütfen tarayıcı geçmişinizi
							temizleyin veya farklı bir tarayıcı deneyin.
              Hala devam mı ediyor? Bize ulaşın: info@gezcez.com
						</p>
					</CardContent>
				</Card>
			</div>
