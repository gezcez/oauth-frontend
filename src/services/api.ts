...
export async function signupUser(data: SignupRequest) {
  const [response, request] = await fetchJSON(`${API_URL}/oauth/account/create`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function authorizeApp(data: AuthorizeRequest) {
  ...
  const [response, request] = await fetchJSON(`${API_URL}/oauth/account/authorize`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
...
export async function getApps() {
  const [response, request] = await fetchJSON(`${API_URL}/oauth/account/get-apps`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
    },
